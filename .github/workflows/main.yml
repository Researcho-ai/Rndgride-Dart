...
class HomeModel extends FlutterFlowModel<HomeWidget> {
  ...
  void removeFromInstrumentTestLIst(String item) => instrumentTestLIst.remove(item);
  void removeAtIndexFromInstrumentTestLIst(int index) => instrumentTestLIst.removeAt(index);
  void insertAtIndexInInstrumentTestLIst(int index, String item) => instrumentTestLIst.insert(index, item);
  ...
  void addToInstrumentaTestResult(dynamic item) => instrumentaTestResult.add(item);
  void removeFromInstrumentaTestResult(dynamic item) => instrumentaTestResult.remove(item);
  void removeAtIndexFromInstrumentaTestResult(int index) => instrumentaTestResult.removeAt(index);
  void insertAtIndexInInstrumentaTestResult(int index, dynamic item) =>
      instrumentaTestResult.insert(index, item);
  void updateInstrumentaTestResultAtIndex(int index, Function(dynamic) updateFn) =>
  ...
  void removeAtIndexFromTestSearchList(int index) => testSearchList.removeAt(index);
  void insertAtIndexInTestSearchList(int index, dynamic item) => testSearchList.insert(index, item);
  ...
  void removeFromFinaResourcesList(dynamic item) => finaResourcesList.remove(item);
  void removeAtIndexFromFinaResourcesList(int index) => finaResourcesList.removeAt(index);
  void insertAtIndexInFinaResourcesList(int index, dynamic item) => finaResourcesList.insert(index, item);
  ...
  void addToSophisticatedResultjson(dynamic item) => sophisticatedResultjson.add(item);
  void removeFromSophisticatedResultjson(dynamic item) => sophisticatedResultjson.remove(item);
  void removeAtIndexFromSophisticatedResultjson(int index) => sophisticatedResultjson.removeAt(index);
  void insertAtIndexInSophisticatedResultjson(int index, dynamic item) =>
      sophisticatedResultjson.insert(index, item);
  void updateSophisticatedResultjsonAtIndex(int index, Function(dynamic) updateFn) =>
  ...
  void insertAtIndexInSugetions(int index, String item) => sugetions.insert(index, item);
  void updateSugetionsAtIndex(int index, Function(String) updateFn) => sugetions[index] = updateFn(sugetions[index]);
  ...
  String? replacedWord;
  late FlutterFlowDynamicModels<SophisticatedInstrumentComponentModel> sophisticatedInstrumentComponentModels1;
  late FlutterFlowDynamicModels<InstrumentsDetailsModel> instrumentsDetailsModels1;
  late DataNotFoundCOmponentModel dataNotFoundCOmponentModel;
  late FlutterFlowDynamicModels<SophisticatedInstrumentComponentModel> sophisticatedInstrumentComponentModels2;
  late FlutterFlowDynamicModels<InstrumentsDetailsModel> instrumentsDetailsModels2;

  // ✅ Fixed: Correct controller type with alias
  cs.CarouselController? webCarouselController;
  ...
  void initState(BuildContext context) {
    ...
    sophisticatedInstrumentComponentModels1 = FlutterFlowDynamicModels(() => SophisticatedInstrumentComponentModel());
    instrumentsDetailsModels1 = FlutterFlowDynamicModels(() => InstrumentsDetailsModel());
    dataNotFoundCOmponentModel = createModel(context, () => DataNotFoundCOmponentModel());
    sophisticatedInstrumentComponentModels2 = FlutterFlowDynamicModels(() => SophisticatedInstrumentComponentModel());
    instrumentsDetailsModels2 = FlutterFlowDynamicModels(() => InstrumentsDetailsModel());
    customerFeedbackWebModel1 = createModel(context, () => CustomerFeedbackWebModel());
    customerFeedbackWebModel2 = createModel(context, () => CustomerFeedbackWebModel());
    customerFeedbackWebModel3 = createModel(context, () => CustomerFeedbackWebModel());
    customerFeedbackMobileModel1 = createModel(context, () => CustomerFeedbackMobileModel());
    customerFeedbackMobileModel2 = createModel(context, () => CustomerFeedbackMobileModel());
    customerFeedbackMobileModel3 = createModel(context, () => CustomerFeedbackMobileModel());
    requermentButtonModel1 = createModel(context, () => RequermentButtonModel());
    requermentButtonModel2 = createModel(context, () => RequermentButtonModel());
    requermentButtonModel3 = createModel(context, () => RequermentButtonModel());
    userRequirementCopyModel = createModel(context, () => UserRequirementCopyModel());
