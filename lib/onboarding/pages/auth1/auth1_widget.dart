                                                  ...
                                                  Padding(
                                                    ...
                                                    child: Text(
                                                      FFLocalizations.of(
                                                              context)
                                                          .getText(
                                                        'fv8zexle' /* Let's get started by filling o... */,
                                                      ),
                                                      style:
                                                          FlutterFlowTheme.of(
                                                                  context)
                                                                ...
                                                                child:
                                                                  ...
                                                                  onPressed:
                                                                    ...
                                                                    logFirebaseEvent(
                                                                        'Button_launch_u_r_l');
                                                                    await launchURL(
                                                                        'https://nittadm.samarth.edu.in/2024/');
                                                                  },
                                                                  text: FFLocalizations.of(
                                                                          context)
                                                                      .getText(
                                                                    'jxvdinde' /* Continue with Google */,
                                                                  ),
                                                                  icon: FaIcon(
                                                                    FontAwesomeIcons
                                                                        .google,
                                                  ...
                                                  Padding(
                                                    ...
                                                    child: Text(
                                                      FFLocalizations.of(
                                                              context)
                                                          .getText(
                                                        'w1roeuf7' /* Let's get started by filling o... */,
                                                      ),
                                                      style:
                                                          FlutterFlowTheme.of(
                                                                  context)
