...
import 'dev_facilities_model.dart';
export 'dev_facilities_model.dart';
...
class _DevFacilitiesWidgetState extends State<DevFacilitiesWidget> {
  late DevFacilitiesModel _model;
  ...
  void initState() {
    ...
    _model.searchIFocusNode!.addListener(
      () async {
        logFirebaseEvent('DEV_FACILITIES_searchI_ON_FOCUS_CHANGE');
              ...
              desktop: false,
                ...
                ? AppBar(
                    ...
                    leading: FlutterFlowIconButton(
                      ...
                      onPressed: () async {
                        logFirebaseEvent(
                            'DEV_FACILITIES_arrow_back_rounded_ICN_ON');
                                              ...
                                              if (responsiveVisibility(
                                                ...
                                                Padding(
                                                  ...
                                                  child: FlutterFlowIconButton(
                                                    ...
                                                    onPressed: () async {
                                                      logFirebaseEvent(
                                                          'DEV_FACILITIES_PAGE_arrowLeft_ICN_ON_TAP');
                                                      logFirebaseEvent(
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      onChanged:
                                                                        ...
                                                                        () async {
                                                                          logFirebaseEvent(
                                                                              'DEV_FACILITIES_searchI_ON_TEXTFIELD_CHAN');
                                                                      ...
                                                                      onFieldSubmitted:
                                                                          (_) async {
                                                                        logFirebaseEvent(
                                                                            'DEV_FACILITIES_searchI_ON_TEXTFIELD_SUBM');
                                                                        var _shouldSetState =
                                                                            false;
                                                                        if (_model.searchITextController.text !=
                                                                            ' ') {
                                                                  ...
                                                                  Padding(
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      onTap:
                                                                          () async {
                                                                        logFirebaseEvent(
                                                                            'DEV_FACILITIES_PAGE_Icon_vf9iun5v_ON_TAP');
                                                                        logFirebaseEvent(
                                                                      ...
                                                                      children: List.generate(
                                                                        ...
                                                                        return Padding(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            onTap:
                                                                                () async {
                                                                              logFirebaseEvent('DEV_FACILITIES_PAGE_Row_cv4ompa3_ON_TAP');
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            children: [
                                                                              if (_model.instrumentLength >= 18)
                                                                                FFButtonWidget(
                                                                                  onPressed: () async {
                                                                                    logFirebaseEvent('DEV_FACILITIES_PAGE_AddButton_ON_TAP');
                                                                                    var _shouldSetState = false;
