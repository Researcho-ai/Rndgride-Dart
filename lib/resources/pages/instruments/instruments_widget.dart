...
class InstrumentsWidget extends StatefulWidget {
  ...
  static String routePath = 'Instrument';
                                                              ...
                                                              Padding(
                                                                ...
                                                                child: InkWell(
                                                                  ...
                                                                  onTap:
                                                                      () async {
                                                                    logFirebaseEvent(
                                                                        'INSTRUMENTS_PAGE_Icon_mcchql13_ON_TAP');
                                                                    logFirebaseEvent(
                                                                    ...
                                                                    return Padding(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        onTap:
                                                                            () async {
                                                                          logFirebaseEvent(
                                                                              'INSTRUMENTS_PAGE_Row_c9esfrvy_ON_TAP');
                                                                          var _shouldSetState =
                                                                              false;
                                                                          logFirebaseEvent(
                                                                              'Row_set_form_field');
                                                ...
                                                children: [
                                                  if (_model.count! >= 16)
                                                    FFButtonWidget(
                                                      onPressed: () async {
                                                        logFirebaseEvent(
                                                            'INSTRUMENTS_PAGE_AddButton_ON_TAP');
                                                        var _shouldSetState =
                                                            false;
                                                        logFirebaseEvent(
